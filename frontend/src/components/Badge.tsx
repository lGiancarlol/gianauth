...
const config: Record<string, BadgeConfig> = {
  ...
  used:            { bg: "bg-blue-500/8",      text: "text-blue-400",    border: "border-blue-500/20",    dot: "bg-blue-400",    label: "Usada"       },
  ...
  completed:       { bg: "bg-blue-500/8",      text: "text-blue-400",    border: "border-blue-500/20",    dot: "bg-blue-400",    label: "Completada"  },
  ...
  reseller:        { bg: "bg-primary/8",       text: "text-primary",     border: "border-primary/20",     dot: "bg-primary",     label: "Revendedor"  },
  open:            { bg: "bg-amber-500/8",     text: "text-amber-400",   border: "border-amber-500/20",   dot: "bg-amber-400",   label: "Abierto"     },
  in_progress:     { bg: "bg-blue-500/8",      text: "text-blue-400",    border: "border-blue-500/20",    dot: "bg-blue-400",    label: "En progreso" },
  ...
  entregada:       { bg: "bg-blue-500/8",      text: "text-blue-400",    border: "border-blue-500/20",    dot: "bg-blue-400",    label: "Entregada"   },
